...
<head>
    ...
    <link rel="stylesheet" href="kitapsil.css">
</head>
<body>
...
<table>
    ...
    <tr>
        ...
        <td>
            <a href="sil_kitap.php?kitap_id=<?php echo isset($kitap['id']) ? $kitap['id'] : ''; ?>" onclick="return confirm('Bu kitabı silmek istediğinizden emin misiniz?');">Sil</a>
        </td>
    </tr>
    <?php endforeach; ?>
</tbody>
